<footer class="bg-tertiary h-24 flex justify-center lg:justify-around text-secondary items-center px-10 max-lg:flex-col max-lg:space-y-1">
	<p>Copyright © 2024 Cemilarupa. Powered by Cemilarupa.</p>
	<div />
	<div />
	<div class="flex space-x-5">
		...
		<a href="https://www.tiktok.com/@cemilarupa.id">
			<svg
				...
				xmlns="http://www.w3.org/2000/svg"
				class="icon flat-color w-5 aspect-square"
				><g id="SVGRepo_bgCarrier" stroke-width="0" /><g
					id="SVGRepo_tracerCarrier"
					stroke-linecap="round"
					stroke-linejoin="round"
		...
		<a href="https://www.instagram.com/cemilarupa.id/">
			<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 aspect-square"
				><g id="SVGRepo_bgCarrier" stroke-width="0" /><g
					id="SVGRepo_tracerCarrier"
					stroke-linecap="round"
					stroke-linejoin="round"
