<script>
	import banner from '$lib/images/1.png';
</script>

<section class="bg-primary grid grid-cols-2 relative" id="home">
	...
	<img src={banner} alt="banner" class="p-10 pr-20" /></section>
